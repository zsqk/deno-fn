...
Deno.test('test-and-and-and-false', () => {
  assert(
    logicCalculate(data, {
      condition: 'AND',
      rules: [
...
Deno.test('test-and-and-or-false', () => {
  assert(
    logicCalculate(data, {
      condition: 'AND',
      rules: [
...
Deno.test('test-and-or-and-false', () => {
  assert(
    logicCalculate(data, {
      condition: 'AND',
      rules: [
...
Deno.test('test-and-or-or-false', () => {
  assert(
    logicCalculate(data, {
      condition: 'AND',
      rules: [
...
Deno.test('test-or-and-and-false', () => {
  assert(
    logicCalculate(data, {
      condition: 'OR',
      rules: [
...
//001
Deno.test('test-or-or-and-false', () => {
  assert(
    logicCalculate(data, {
      condition: 'OR',
      rules: [
...
//3层逻辑 000
Deno.test('test-or-or-or-or-false', () => {
  assert(
    logicCalculate(data, {
      condition: 'OR',
      rules: [
